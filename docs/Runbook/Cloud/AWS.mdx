...
AWS provides a broad suite of **cloud services** including compute, storage, database, messaging, and analytics. This runbook focuses on key data and messaging services commonly used by engineers and monitored by TAs: ElastiCache, DynamoDB, Keyspaces, SQS, and SNS.
:::
...
* Use AWS when building cloud-native applications requiring managed services.
* Use DynamoDB / Keyspaces for low-latency, highly available databases.
* Use ElastiCache for caching and fast in-memory operations.
* Use SQS / SNS for decoupled, event-driven architectures.

**Do NOT use AWS services when:**

* On-premises or lower-cost alternatives suffice.
* You need extremely low-level control over infrastructure not exposed by managed services.

---

## TA Skills Checklist

- Identify service usage and data flow between AWS services.
- Validate IAM roles, policies, and access control.
- Observe metrics, alerting, and scaling considerations.
- Verify integration with dashboards, pipelines, and notifications.
...
</TabItem> <TabItem value="swe-ec" label="SWE Skills">
...
</TabItem> <TabItem value="dynamodb" label="DynamoDB">
...
</TabItem> <TabItem value="keyspaces" label="Keyspaces">
...
</TabItem><TabItem value="messaging" label="SQS/SNS">
...
:::danger
Symptoms of issues with AWS data and messaging services and how to triage:
:::
