...
// Authenticate to Google Cloud (interactive user login)
gcloud auth login

// Authenticate application-default credentials (used by SDKs, Terraform, BigQuery)
...
// List all BigQuery datasets in the active project
bq ls
...
// Show dataset metadata including labels and location
bq show --format=prettyjson PROJECT_ID:DATASET

// Check partitioning and clustering details for a table
...
// View IAM policy bindings for the project
...
// Read recent logs (example: compute instances)
...
// Sanity check: is the namespace real?
kubectl get namespaces

// Sanity check: is storage actually attached?
kubectl get pvc -n NAMESPACE
