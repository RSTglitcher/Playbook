...
│   └── Aggregations
├── TA Skills
│   ├── Validate mappings & analyzers
│   ├── Review shard/replica strategy
│   ├── Inspect queries & relevance issues
│   ├── Support consumers & governance
│   └── Triage performance & data issues
└── SWE Skills
    ├── Index & schema design
    ├── Query optimisation
...
# Never start large — expand iteratively
