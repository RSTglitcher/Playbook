...
| Action | Requirements |
|--------|-------------|
| Install / Setup | Prometheus server deployed (self-hosted or SaaS) |
| Access & Login | Web UI accessible; optional API token for scripted access |
| Metrics Source | Target endpoints expose `/metrics` |
| Integrations | Grafana or other visualization tools configured |
