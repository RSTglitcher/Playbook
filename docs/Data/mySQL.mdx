---
created: 2024-07-28T22:09:30+01:00
modified: 2024-07-28T22:09:52+01:00
---
...
**2. Port Forward from the `gott-datahub-deps` service to your laptop**
...
- Run the following command to set up port forwarding:
    - `kubectl port-forward services/gott-datahub-deps` port:port
